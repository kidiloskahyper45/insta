...
from leslie.events import register
from leslie.utils import progress
        ...
        await v_url.client.send_file(
            ...
            attributes=[
                DocumentAttributeAudio(duration=int(rip_data['duration']),
                        ...
                        caption=f"`it's time to listen 🎧`\
                                   \n\n**Song:** {rip_data['title']}\
                                   \n**Duration:** {rip_data['duration']}Sec\
                                   \n**Author:** {rip_data['uploader']}\
                                   \n**Uploded by:** @MissLeslieBot 🦋",
